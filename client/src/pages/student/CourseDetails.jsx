    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left '>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Vishal</span> </p>
          ...
          <div className='py-20 text-sm md:text-default '>
            <h3 className='text-xl font-semisolid text-gray-800'>Course Description</h3>
        ...
        md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5 '>
            ...
            <div className='flex  gap-3 items-center pt-2 '>
              ...
              <p className='md:text-lg text-gary-500 line-through'>{currency}{courseData.coursePrice} </p>
              <p className='md:text-lg text-gary-500'>{courseData.discount} % off</p>
            </div>
